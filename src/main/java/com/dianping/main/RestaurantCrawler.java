...
public class RestaurantCrawler {
    ...
    public void crawl(ArrayList<String> existUrls) {
        ...
        RedisScheduler redisScheduler = new RedisScheduler(new JedisPool(new JedisPoolConfigExtend(),HOST_ADDRESS,6379,500,PASSWORD));
...
//        		.setIsExtractLinks(false)
        		...
        		.addUrl("http://www.dianping.com/search/category/1/10/g508o3")
        		.thread(40)
